        ...
        <main className="pt-32">
            ...
            <section className="py-20 bg-white/5 relative overflow-hidden">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <div className="flex flex-wrap justify-center items-end gap-12 md:gap-24 opacity-60 grayscale hover:grayscale-0 transition-all duration-700">
                        {/* Instagram */}
                        ...
                        {/* Google Business */}
                        <div className="flex flex-col items-center gap-4 group/icon">
                            <div className="text-white group-hover/icon:text-[#4285F4] transition-colors duration-500">
                                <svg className="w-10 h-10 md:w-12 md:h-12" fill="currentColor" viewBox="0 0 24 24">
