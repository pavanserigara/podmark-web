            ...
            <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
                ...
                <div ref={headerRef} className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    <div className='flex flex-col md:flex-row gap-6 justify-center'>
                        <a
                            href="https://wa.me/918105575795?text=I%27m%20interested%20in%20Real%20Estate%20Shoots%20services."
                            target="_blank"
            ...
            <section className="py-20 md:py-32 text-center">
                <div className="container mx-auto px-6">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-block px-12 py-5 bg-gradient-to-r from-podGold to-amber-600 text-black font-black tracking-widest uppercase rounded-full hover:scale-105 transition-transform shadow-2xl"
                    >
                        Schedule Your Shoot
                    </a>
                </div>
