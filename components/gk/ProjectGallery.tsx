      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
          {GALLERY_IMAGES.map((image, idx) => (
            <div key={idx} className="relative group overflow-hidden rounded-3xl bg-podDeepPurple break-inside-avoid shadow-2xl">
              <img
                src={image.url}
                alt={image.title}
        ...
        <div className="mt-20 flex justify-center">
          <button className="px-8 py-4 bg-podDeepPurple hover:bg-podDeepPurple/80 text-slate-300 font-bold rounded-2xl border border-white/5 transition-all hover:scale-105">
            Explore All Assets
          </button>
        </div>
      </div>
