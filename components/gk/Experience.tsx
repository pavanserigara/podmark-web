...
import { MapPin, Calendar, Award, ChevronDown, ChevronUp } from 'lucide-react';
import { ExperienceEntry } from './types';

const ExperienceItem: React.FC<{ exp: ExperienceEntry; idx: number; isLast: boolean }> = ({ exp, idx, isLast }) => {
