...
const About: React.FC = () => {
  return (
    <section id="about" className="py-20 md:py-24 px-4 sm:px-6 bg-pod-dark">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center">
          <div className="relative px-4 sm:px-0 max-w-md mx-auto lg:max-w-none lg:mx-0">
            <div className="aspect-square rounded-[2rem] md:rounded-[3rem] bg-pod-deep-purple border-2 border-white/5 overflow-hidden relative shadow-2xl">
              <img 
            ...
            <div className="absolute -bottom-4 -right-2 sm:-bottom-6 sm:-right-6 bg-pod-deep-purple border border-white/10 p-4 md:p-6 rounded-xl md:rounded-2xl shadow-2xl backdrop-blur-md">
              <p className="text-3xl md:text-4xl font-bold text-pod-purple mb-1">15+</p>
              <p className="text-[10px] md:text-sm font-medium text-slate-400">Years of IT Training Experience</p>
            </div>
          </div>

          <div className="text-center lg:text-left mt-8 lg:mt-0">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 leading-tight">Empowering the Next Generation of <span className="text-pod-cyan">Cloud Architects.</span></h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-10">
              <div className="p-5 bg-pod-deep-purple/50 rounded-2xl border border-white/5 text-left">
                <Target className="w-8 h-8 text-pod-cyan mb-4" />
              ...
              <div className="p-5 bg-pod-deep-purple/50 rounded-2xl border border-white/5 text-left">
                <Award className="w-8 h-8 text-pod-gold mb-4" />
            ...
            <div className="flex items-center gap-4 p-4 rounded-2xl bg-pod-purple/5 border border-pod-purple/10 text-left">
              <Users className="text-pod-purple w-8 h-8 md:w-10 md:h-10 shrink-0" />
              <div>
